		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Patient Name: {{$patient->first_name}} {{$patient->middle_name}} {{$patient->last_name}}
					<a class="btn btn-primary pull-right" data-toggle="modal" href="#editPatient"><span class="glyphicon glyphicon-edit"></span> Edit Patient</a>
				</div>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">Patient Appointment
					<a class="btn btn-primary pull-right" data-toggle="modal" href="#addAppointment"><span class="glyphicon glyphicon-plus"></span>Add Appointment</a>
				</div>
				<div class="panel-body">
