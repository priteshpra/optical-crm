    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{route('dashboard.index')}}"><i class="fas fa-clinic-medical"></i> Rathod
                    Optical Management System</a>
            </div>
            <ul class="nav navbar-nav">
                <li class="{{ request()->is('/*') ? 'active' : '' }}"><a href="{{route('dashboard.index')}}"><i
                            class="fas fa-home"></i> Dashboard</a></li>
                @permission('department.index')
                <li
                    class="dropdown {{ request()->is('department*') || request()->is('service*') || request()->is('package') || request()->is('employee*') || request()->is('doctor*') || request()->is('invoice/report') ? 'active' : '' }}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fas fa-users-cog"></i> Admin <span class="caret"></span></a>
                ...
                <li
                    class="dropdown {{ request()->is('patient*') || request()->is('appointment*') || request()->is('repairing*') ? 'active' : '' }}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"> <i class="fas fa-hospital-user"></i> Patient <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown {{ request()->is('account/*') ? 'active' : '' }}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fas fa-file-medical-alt"></i> Report <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li
                    class="dropdown {{ request()->is('invoice*') || request()->is('opd*') || request()->is('package/sale') || request()->is('search/invoice') ? 'active' : '' }}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fas fa-receipt"></i> Invoice/Bill <span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                ...
                <li
                    class="dropdown {{ request()->is('user*') || request()->is('role*') || request()->is('setting') || request()->is('backup') ? 'active' : '' }}">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fas fa-tools"></i> Setting<span class="caret"></span></a>
                    <ul class="dropdown-menu">
