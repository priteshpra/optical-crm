	...
	<div class="row">
		<div class="col-md-8">
			<div class="panel panel-default">
				<div class="panel-heading">Service Table<a class="btn btn-sm btn-primary pull-right"
						href="{{url('/')}}">Back <span class="glyphicon glyphicon-share-alt"></span></a></div>
					...
					<table id="example" class="table table-bordered table-condensed" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr class="sevice{{$service->id}}">
								...
								<td>
									<button style="margin-right: 5px" class="btn-sm btn-info edit_service"
										data-info="{{$service->id}},{{$service->name}},{{$service->amount}},{{$service->department_id}}"><span
											class="glyphicon glyphicon-edit"></span>
									</button>
									<button class="btn-sm btn-danger" id="delete_service"
										data-id="{{$service->id}}"><span
